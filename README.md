# Docker Webmaster (Easy Mode / Auto Install / All In One)
## [full stack nginx Webmaster Mode for Everyone with Docker Compose (For All Web Administrator)](https://github.com/xLLMA/DockerWebmaster 'full stack nginx Webmaster Mode for Everyone with Docker Compose')
...
```
git clone https://github.com/xLLMA/DockerWebmaster.git
```
